...
import (
	...
	etcdservergw "github.com/tudyzhb/etcd/api/v3/etcdserverpb/gw"
	"github.com/tudyzhb/etcd/client/v3/credentials"
	"github.com/tudyzhb/etcd/pkg/v3/debugutil"
	"github.com/tudyzhb/etcd/pkg/v3/httputil"
	"github.com/tudyzhb/etcd/pkg/v3/transport"
	"github.com/tudyzhb/etcd/server/v3/etcdserver"
	"github.com/tudyzhb/etcd/server/v3/etcdserver/api/v3client"
	"github.com/tudyzhb/etcd/server/v3/etcdserver/api/v3election"
	"github.com/tudyzhb/etcd/server/v3/etcdserver/api/v3election/v3electionpb"
	v3electiongw "github.com/tudyzhb/etcd/server/v3/etcdserver/api/v3election/v3electionpb/gw"
	"github.com/tudyzhb/etcd/server/v3/etcdserver/api/v3lock"
	"github.com/tudyzhb/etcd/server/v3/etcdserver/api/v3lock/v3lockpb"
	v3lockgw "github.com/tudyzhb/etcd/server/v3/etcdserver/api/v3lock/v3lockpb/gw"
	"github.com/tudyzhb/etcd/server/v3/etcdserver/api/v3rpc"
