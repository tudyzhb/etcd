...
running(leaking) after all tests.
	...
	import "github.com/tudyzhb/etcd/pkg/v3/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "github.com/tudyzhb/etcd/pkg/v3/testutil.interestingGoroutines") ||
			strings.Contains(stack, "github.com/tudyzhb/etcd/pkg/v3/logutil.(*MergeLogger).outputLoop") ||
