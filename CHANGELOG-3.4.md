...
- Move [`"github.com/coreos/etcd"`](https://github.com/etcd-io/etcd/issues/9965) to [`"github.com/etcd-io/etcd"`](https://github.com/etcd-io/etcd/issues/9965).
  - Change import path to `"github.com/tudyzhb/etcd"`.
  - e.g. `import "github.com/tudyzhb/etcd/raft"`.
...
- Move internal packages to `etcdserver`.
  - `"github.com/coreos/etcd/alarm"` to `"github.com/tudyzhb/etcd/etcdserver/api/v3alarm"`.
  - `"github.com/coreos/etcd/compactor"` to `"github.com/tudyzhb/etcd/etcdserver/api/v3compactor"`.
  - `"github.com/coreos/etcd/discovery"` to `"github.com/tudyzhb/etcd/etcdserver/api/v2discovery"`.
  - `"github.com/coreos/etcd/etcdserver/auth"` to `"github.com/tudyzhb/etcd/etcdserver/api/v2auth"`.
  - `"github.com/coreos/etcd/etcdserver/membership"` to `"github.com/tudyzhb/etcd/etcdserver/api/membership"`.
  - `"github.com/coreos/etcd/etcdserver/stats"` to `"github.com/tudyzhb/etcd/etcdserver/api/v2stats"`.
  - `"github.com/coreos/etcd/error"` to `"github.com/tudyzhb/etcd/etcdserver/api/v2error"`.
  - `"github.com/coreos/etcd/rafthttp"` to `"github.com/tudyzhb/etcd/etcdserver/api/rafthttp"`.
  - `"github.com/coreos/etcd/snap"` to `"github.com/tudyzhb/etcd/etcdserver/api/snap"`.
  - `"github.com/coreos/etcd/store"` to `"github.com/tudyzhb/etcd/etcdserver/api/v2store"`.
...
- Change [`pkg/adt.IntervalTree` from `struct` to `interface`](https://github.com/etcd-io/etcd/pull/10959).
  - See [`pkg/adt` README](https://github.com/etcd-io/etcd/tree/master/pkg/adt) and [`pkg/adt` godoc](https://godoc.org/github.com/tudyzhb/etcd/pkg/adt).
